...
class Model(nn.Module):
	...
	def get_input_embeddings(self, input_ids=None, pixel_values=None, **kwargs):
		...
		if pixel_values is None:
			return {"inputs_embeds": self.language_model.model.embed_tokens(input_ids), "visual_pos_masks": None, "deepstack_visual_embeds": None}
	...
	def __call__(self, input_ids, pixel_values=None, mask=None, cache=None, **kwargs):
		...
		kwargs.update({"pixel_values": pixel_values, **inputs_embeds})
