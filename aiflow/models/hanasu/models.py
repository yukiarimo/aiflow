...
def convert_to_single_speaker(
    ckpt_paths,
    new_emb_size=512,
    output_suffix="_single"
):
    """
    Convert multi-speaker model checkpoints to single-speaker versions.

    Args:
        ckpt_paths: Path to checkpoint file or list of checkpoint paths
        new_emb_size: Size for new speaker embedding (e.g., 512). If None, no new embedding is added.
        output_suffix: Suffix to add to output filenames (default: "_single")
    ...
    def remove_speaker_embeddings(model_dict):
        ...
        possible_keys = [
            "emb_g.weight", "speaker_embedding.weight", "speaker_emb.weight", "spk_embed.weight"
        ]
        removed = []
